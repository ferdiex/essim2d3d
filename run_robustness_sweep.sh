...
echo "=================================================="
python3 latent_drem/spearman_significance.py --csvs "$CSVS_JOINED" --labels "$LABELS_JOINED"
